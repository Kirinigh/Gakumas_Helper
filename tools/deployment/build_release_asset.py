    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="gakumas-release-", dir=output_dir) as temporary:
        ...
        release_manifest = {
            ...
            "known_gates": [
                "TASK-085 upgraded-marker and broader real-window evidence remain open",
                "TASK-410 second-window blind validation remains open",
                "TASK-400 final product acceptance remains blocked by TASK-085 and TASK-410",
            ],
        }
