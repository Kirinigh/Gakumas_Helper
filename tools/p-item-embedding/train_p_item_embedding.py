...
if _SPEC is None or _SPEC.loader is None:
    raise RuntimeError("unable to load shared TASK-075 embedding training primitives")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Train the TASK-085 P-item embedding and gallery")
