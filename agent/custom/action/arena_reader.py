...
from arena_winrate._reader_evidence import (
    _PItemPanelRow,
    _NormalizedPItemRow,
    _DetailIdentityProof,
    _PItemOcrObservation,
    _TitleBoundEffectRoiText,
...
class MaaArenaReaderBackend:
    ...
    def _confirm_p_item_detail_once(
        ...
        *,
        ...
        return PItemDetailSession(self, time,
            box=box,
    ...
    def _assert_card_group_visible(
        ...
        *,
        ...
        return SourceRestoreSession(
            self, group_index, timeout_seconds, card_slot, expected_card_id, time,
