...
class MaaArenaReaderBackend:
    ...
    def _card_cost_references(self) -> GenericCostReferenceGallery:
        ...
        try:
            ...
            raise ArenaReaderError(
                ...
                "TASK-410 compact card-face cost gallery is unavailable or invalid",
            ) from error
        return self._card_cost_reference_gallery
    ...
    def _card_recognizer(self, *, customized: bool) -> tuple[EmbeddingCardRecognizer, float, float]:
        ...
        null TASK-077/TASK-100 thresholds therefore remain a ban on accepting a
        ...
        with self._card_recognizer_lock:
            ...
            try:
                ...
                task_id = "TASK-077" if customized else "TASK-075"
                raise ArenaReaderError(
                    "skill_card_runtime_not_approved",
                    f"{task_id} embedding candidate assets are unavailable",
                ) from error
    ...
    def _card_visual_family_candidates(
        ...
        *,
        ...
        """Union TASK-075 and TASK-077 Top-K families before a detail click.
        ...
        if not ordered:
            raise ArenaReaderError(
                ...
                "neither TASK-075 nor TASK-077 supplied a visual family for the "
            ...
            try:
                ...
                if len(plan_candidates) != 1:
                    try:
                        ...
                        # TASK-075 is only an optional disambiguator for a
    ...
    def _stable_zero_card_embedding_family_candidates(
        ...
        *,
        ...
        """Return the TASK-075 top-family IDs stable in the same three frames.
        ...
        for frame_index, frame in enumerate(frames):
            ...
            if not prediction.accepted or not prediction.top_k_card_ids:
                raise BadgeReferenceError(
                    "TASK-075 did not yield an accepted top visual family for "
    ...
    def read_skill_card_id_hints(
        ...
        for index, (box, customization_count) in enumerate(
            ...
            if customized:
                # TASK-077 supplies only bounded visual-family candidates.  A
