...
def agent():
    try:
        ...
        from arena_winrate.evidence_retention import cleanup_arena_evidence_on_startup
        from arena_winrate.upstream_component import (
            sync_arena_season_ui_on_startup,
            check_arena_component_on_startup,
        )

        cleanup_arena_evidence_on_startup(logger)
        sync_arena_season_ui_on_startup()
        check_arena_component_on_startup()
